...
// Removing metadata export as it conflicts with 'use client' directive
// The redirect is already handled in next.config.js
...
export default function PasswordProtected() {
  ...
  useEffect(() => {
    // Using a hardcoded password for development
    // In production, this should be handled by the API
    const hardcodedPassword = process.env.NEXT_PUBLIC_APP_PASSWORD || 'chromalink';
